...
class SpectrogramUpsampler(nn.Module):
  ...
  def forward(self, x):
    # torch.Size([1, 20, 104])
    x = torch.unsqueeze(x, 1) # torch.Size([1, 1, 20, 104])
    x = self.conv1(x) # torch.Size([1, 1, 20, 1664])
    x = F.leaky_relu(x, 0.4) # torch.Size([1, 1, 20, 1664])
    #x = self.conv2(x) # torch.Size([1, 1, 20, 26624])
    #x = F.leaky_relu(x, 0.4) # torch.Size([1, 1, 20, 26624])
    x = torch.squeeze(x, 1)
    return x
